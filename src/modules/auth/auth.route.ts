...
import { decodeRefreshToken, generateJwtRefreshToken, validateJwtRefreshToken } from "../../helper/jwt";
...
export function authRoutes(route: FastifyInstance) {
    ...
    route.post("/refreshToken", { schema: { tags: ["Auth"], body: targetConstructorToSchema(RefreshTokenDto) } }, (req, res) => Controller.refreshToken(req, res))
}